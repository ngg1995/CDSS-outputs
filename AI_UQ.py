...
class AI_UQProb(Scene):
    def construct(self):
        ...
        t2 = Tex(f"The algorithm says that the probability of\\\\the patient having $D$ is between ${p.midpoint()}\pm{p.width()/2:.3f}$")
