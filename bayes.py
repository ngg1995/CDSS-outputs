...
class BayesNatFreq(Scene):
    def construct(self):
        ...
        # self.add(root, sick, well, sickpos, sickneg, wellpos, wellneg, graph)

        # # Animate the tree
        # self.play(Create(graph))
        # self.wait(2)
        
class BayesIconArray(Scene):
    def construct(self):
        p = 0.25
        s = 0.67
        t = 0.80
